...
export function App() {
  ...
  <text x="50%" y="420" font-family="sans-serif" font-weight="bold" font-size="64" fill="${preset.accentColor}" text-anchor="middle">IRON</text>
		...
		const colorId = preset.id || "green";
		const touchIcon = document.getElementById("apple-touch-icon");
		if (touchIcon) touchIcon.setAttribute("href", `/apple-touch-icon-${colorId}.png`);
		...
		// Generate dynamic manifest JSON with the color-matched PWA icon and apple touch icon
