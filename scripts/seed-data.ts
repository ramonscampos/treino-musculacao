export function parseSets(s: string): {
	sets?: number;
	repsMin?: number;
	repsMax?: number;
} {
	...
	SEG: {
		...
		exercises: [
			...
			},
			{
				name: "Leg Press 45°",
				executionCues: [
					"Pés baixos e relativamente fechados",
					"Foco em quadríceps",
				],
				muscleFocus: "Quadríceps",
				sets: "4x10–12",
	...
	TER: {
		...
		exercises: [
			...
			},
			{
				...
				executionCues: [
					"Movimento subindo em direção ao rosto",
					"Foco total em peito superior",
				],
				muscleFocus: "Peito superior",
				sets: "3x12–15",
				rest: "90s",
		...
		exercises: [
			{
				...
				executionCues: [
					"Pegada pronada",
					"Trazer para parte superior do peito",
				],
				muscleFocus: "Costas",
				sets: "4x8–10",
				rest: "2min",
		...
		exercises: [
			{
				...
				executionCues: [
					"Coluna neutra",
					"Quadril para trás",
					"Alongamento máximo da posterior",
				],
...
export const ANDRESSA_DATA: Record<string, RawDayData> = {
	...
	QUA: {
		...
		exercises: [],
		rest: true,
		extra: "Bikezinha, esteira ou a escada do capiroto",
	},
	QUI: {
	...
	SEX: {
		title: "SEXTA — A DEFINIR",
		exercises: [],
		extra: "Só falta esse, mô",
	},
	SAB: {
